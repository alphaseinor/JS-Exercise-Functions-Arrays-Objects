...
function getName(props) {
  return `Hello, my name is ${props.name}`
}
...
function getLastCarInfo(inventory) {
  const ilength = inventory.length 
  return `This is a ${inventory[ilength-1].car_make} ${inventory[ilength-1].car_model}`
